...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  full: [
    ...
    'ais', 'liveTankers', 'tradeRoutes', 'flights', 'protests',
...
export const LAYER_SYNONYMS: Record<string, Array<keyof MapLayers>> = {
  ...
  plane: ['flights'],
  notam: ['flights'],
  ship: ['ais', 'liveTankers', 'tradeRoutes'],
  vessel: ['ais', 'liveTankers'],
  tanker: ['liveTankers', 'ais'],
  maritime: ['ais', 'liveTankers', 'waterways', 'tradeRoutes'],
  sea: ['ais', 'liveTankers', 'waterways', 'cables'],
  ocean: ['cables', 'waterways'],
  war: ['conflicts', 'ucdpEvents', 'military'],
  battle: ['conflicts', 'ucdpEvents'],
  army: ['military', 'bases'],
  navy: ['military', 'ais', 'liveTankers'],
